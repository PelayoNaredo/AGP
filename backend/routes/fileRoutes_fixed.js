...
import { monitorResourceUsage } from "../middleware/featureAccess.js";
...
router.get(
  ...
  verifyToken,
  tenantContext,
  monitorResourceUsage("storage", 90), // Monitorear uso de almacenamiento al 90%
  serveFile
);
...
router.get(
  ...
  verifyToken,
  tenantContext,
  monitorResourceUsage("storage", 90), // Monitorear almacenamiento
  serveFile
);
