...
const ExpensesPage = () => {
  ...
  }, [selectedDate.month, selectedDate.year, searchTerm, isLoading]);
  ...
  }, [selectedDate.month, selectedDate.year, searchTerm]);
  ...
  const ExpenseSection = React.memo(({ title, data, type, total }) => (
    <View style={styles.sectionContainer}>
      ...
      >
        ...
        <View>
          <Text style={[styles.totalText, { color: themeObject.colors.text }]}>
            Total: ${total}
          </Text>
        </View>
      </View>

      <View style={[styles.listWrapper, isMobile && styles.listWrapperMobile]}>
        {isLoading ? (
  ...
  return (
    <View style={{ flex: 1 }}>
      ...
      <View style={[styles.container, dynamicStyles.container]}>
        ...
        <View
          style={[styles.listContainer, isMobile && styles.listContainerMobile]}
        >
          <View
